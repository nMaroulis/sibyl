...
with st.form(key='forecasting_form', border=True, clear_on_submit=False):
    ...
    st.toggle("Advanced Analytics", value=True, disabled=False, help="Advanced statistics will be shown even if disabled.")
    st.toggle("Forecasting", value=False, disabled=True)

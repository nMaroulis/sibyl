...
def api_status_check():
    if "api_status_check" not in st.session_state:
        ...
        st.session_state["coinbase_sandbox_api_status"] = status_list[4]
        ...
        if st.session_state["coinbase_sandbox_api_status"] == "Active":
            st.session_state["available_exchange_apis"].append("Coinbase Sandbox")

...
def fetch_wiki_rag_response(model_source: str, model_type: str, model_name: Optional[str], query: str) -> str:

    url = f"{BACKEND_SERVER_ADDRESS}/wiki/chatbot/query?model_source={model_source}&model_type={model_type}&query={query}"
    if model_name:
